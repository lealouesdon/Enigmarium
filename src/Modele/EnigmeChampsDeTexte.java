...
public class EnigmeChampsDeTexte extends Enigme{
    ...
    public void initialiseEnigme1(){//initialisation pour l'enigme de Bérangere la bergere
        ...
        this.question="<html><br>Il faut chercher le côté jaune.<br> Berangère sait que: <br> -le côté Bleu mesure "+String.valueOf(a)+" mètres"+"<br>-le côté rouge mesure "+String.valueOf(b)+" mètres<br> "+"(rep "+String.valueOf(this.valAttendu)+")"+"</html>";
        //indice
