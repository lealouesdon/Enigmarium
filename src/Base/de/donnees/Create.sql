...
Create table OAppartientC(
	...
	objet varchar(20), /*objet se trouvant dans la case*/
...
Create table Quete(
	...
	description varchar(200) not null, /*description de la quete*/
	nbenigmes int not null, /*nombre d'enigmes a realiser*/
	avancee int /* avancee de la quete quand avancee = nbenigmes => fin*/
);
...
Create table Histoire(
	...
	avancee int /*avancee dans l'histoire quand nbQuetes = avancee => fin */
);
